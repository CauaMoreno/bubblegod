...
export async function firstLogin(session:Session) {
    ...
    if (guns.data?.length!=0) {
        ...
        await updateGun({nome:"Arminha bolhuda",block:true,session:session,valor_segundo:5,valor_click:10,valor_desbloqueio:150,codigo_imagem:"https://hcsmsnyvmcgkgvnppedi.supabase.co/storage/v1/object/sign/assets/guns/New%20Piskel%20(2).png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJhc3NldHMvZ3Vucy9OZXcgUGlza2VsICgyKS5wbmciLCJpYXQiOjE3Mzc3OTY2OTQsImV4cCI6NDg5MTM5NjY5NH0.4TE5uUlPTceTFesm7SFLeJycgfH106m-WOx_JXjzyuI&t=2025-01-25T09%3A18%3A14.430Z"})
        ...
        await updateGun({nome:"Aquecedor de bolhas",block:true,session:session,valor_desbloqueio:1500,valor_segundo:30,valor_click:60,codigo_imagem:"https://hcsmsnyvmcgkgvnppedi.supabase.co/storage/v1/object/sign/assets/guns/New%20Piskel%20(5).png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJhc3NldHMvZ3Vucy9OZXcgUGlza2VsICg1KS5wbmciLCJpYXQiOjE3Mzc3OTY3MzQsImV4cCI6NDg5MTM5NjczNH0.5XBZRGSNkcPZZWPh-3wbBOhpuCE2tA91H_Iq12-M3TE&t=2025-01-25T09%3A18%3A54.189Z"})
        await updateGun({nome:"Bolha de aço ",block:true,session:session,valor_segundo:100,valor_desbloqueio:5000,valor_click:200,codigo_imagem:"https://hcsmsnyvmcgkgvnppedi.supabase.co/storage/v1/object/sign/assets/guns/New%20Piskel%20(7).png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJhc3NldHMvZ3Vucy9OZXcgUGlza2VsICg3KS5wbmciLCJpYXQiOjE3Mzc4MDMyNjAsImV4cCI6MTczODQwODA2MH0.fvNg8dDmpeOBOlOVvIHSzcfRhFqCpBjwfCSPvcGS124&t=2025-01-25T11%3A07%3A40.279Z"})
        await updateGun({nome:"Bolha atômica",block:true,session:session,valor_segundo:3,valor_desbloqueio:100000,valor_click:5,codigo_imagem:"https://hcsmsnyvmcgkgvnppedi.supabase.co/storage/v1/object/sign/assets/guns/New%20Piskel%20(3).png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJhc3NldHMvZ3Vucy9OZXcgUGlza2VsICgzKS5wbmciLCJpYXQiOjE3Mzc3OTY3MTAsImV4cCI6NDg5MTM5NjcxMH0.Y37XExB6noXYynA4tTTxCkNZBeU5sqWSd5VRs4EAZj8&t=2025-01-25T09%3A18%3A31.018Z"})
