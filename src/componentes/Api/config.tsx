        ...
        updateProfile({detergente:0,session:session}).then(
          async ()=>{
            ...
            if (guns.data?.length!=0) {
                ...
                await insereGun({nome:"Bolhão Erlenmeyer",block:true,session:session,valor_segundo:20,valor_desbloqueio:850,valor_click:50,codigo_imagem:"https://hcsmsnyvmcgkgvnppedi.supabase.co/storage/v1/object/sign/assets/guns/New%20Piskel%20(4).png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJhc3NldHMvZ3Vucy9OZXcgUGlza2VsICg0KS5wbmciLCJpYXQiOjE3Mzc5MTQ5NzMsImV4cCI6NDg5MTUxNDk3M30.a8QizXvYfv9osFFZNr9snp5kqzAM9jhfoEwA7SYhCYM&t=2025-01-26T18%3A09%3A35.023Z",
                ...
                await insereGun({nome:"Bolha atômica",block:true,session:session,valor_segundo:0,valor_desbloqueio:10000,valor_click:0,codigo_imagem:"https://hcsmsnyvmcgkgvnppedi.supabase.co/storage/v1/object/sign/assets/guns/New%20Piskel%20(3).png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJhc3NldHMvZ3Vucy9OZXcgUGlza2VsICgzKS5wbmciLCJpYXQiOjE3Mzc3OTY3MTAsImV4cCI6NDg5MTM5NjcxMH0.Y37XExB6noXYynA4tTTxCkNZBeU5sqWSd5VRs4EAZj8&t=2025-01-25T09%3A18%3A31.018Z",
